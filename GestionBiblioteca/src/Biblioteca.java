...
public class Biblioteca
{
   public static void main ( String argv[]){
       ...
       prestados.pon( new Libro(28,"El Decamerón","Giovanni Boccaccio",Genero.CUENTOS,1992));
   ...
   public static int prestarLibro ( String titulo, ListaLibros lprestados, ListaLibros ldisponibles){
      ...
      if ( idprestado == -1 && iddisponible == -1) resu = 0; // No esta en catalogo
        
      if ( idprestado !=  -1) resu = -1; // Esta prestado
      if ( iddisponible != -1){
